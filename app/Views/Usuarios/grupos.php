        ...
        <div class="user-block text-center block">
            ...
            <?php if (empty($gruposDisponiveis)) : ?>
                ...
                <?php if ($usuario->full_control == false) : ?>
                    ...
                    <p class="contributions text-warning mt-0">Esse usuario já faz parte de todos os grupos disponiveis!</p>

                <?php else : ?>

                    <p class="contributions text-danger mt-0">Esse usuário já faz parte do grupo Administrador. <br>
                        Para incluí-lo a outros grupos , favor remover do grupo Administrador!</p>
            ...
            <?php else : ?>
                ...
                <div class="form-group">
                    <label class="form-control-label">Escolha os grupos </label>
